...
export default class CouponItem extends Vue {
  @Prop({ default: null })
  private coupons?: Array<any>

  $evt: any
  private defaultConf: any = util.copyObj(compConfig['coupon'])
  private items: Array<any> = this.coupons || []

  @Watch('coupons', { deep: true })
  private watchCoupons (val: Array<any>): void {
    this.items = val
  }

  private showClick (coupon: any, idx: number): void {
